module "lb" {
  ...
  enable_api_vip         = var.enable_api_vip && var.lb_attach_api_vip
  enable_router_vip      = var.enable_router_vip && var.lb_attach_router_vip
  enable_nat_vip         = var.enable_nat_vip && var.lb_attach_nat_vip
